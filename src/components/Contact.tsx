...
const Contact = () => {
  return (
    <section id="contact" className="section-padding bg-restaurant-beige/30">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <form className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      type="text"
                      id="name"
                      className="w-full border border-restaurant-beige rounded-md p-2 focus:outline-none focus:ring-1 focus:ring-restaurant-brown"
                    />
                  </div>
                  <div>
                ...
                <Button 
                  type="submit" 
                  className={cn(
                    "w-full bg-restaurant-brown text-white hover:bg-restaurant-brown/90",
                    "font-medium"
                  )}
                >
                  Enviar Reserva
