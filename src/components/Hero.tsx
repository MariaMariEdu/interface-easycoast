...
const Hero = () => {
  return <section id="home" className="hero-section overlay-dark-50">
      ...
      <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Button size="lg" className={cn("bg-restaurant-orange text-white hover:bg-restaurant-orange/90", "border-2 border-restaurant-orange font-medium px-8")}>
            Reserve uma Mesa
          </Button>
          <Button variant="outline" size="lg" className="text-orange-200">
            Ver Cardápio
          </Button>
        </div>
      </div>
