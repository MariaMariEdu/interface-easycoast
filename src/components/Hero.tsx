...
const Hero = () => {
  return <section id="home" className="hero-section overlay-dark">
      ...
      <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mx-[122px]">
          ...
          <Button variant="outline" size="lg" className="mx-[26px] my-[12px] text-base font-semibold bg-slate-100">
            Ver Cardápio
          </Button>
        </div>
      </div>
